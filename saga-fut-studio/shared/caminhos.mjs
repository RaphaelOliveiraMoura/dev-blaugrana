...
// JPEG derivado só pro Buffer (TikTok recusa PNG). Fora de posts/: misturar com o PNG faz
// a cópia pro celular levar o arquivo errado junto.
export const quadrinhoSlideJpeg = (quadId, numero) => `quadrinhos/${quadId}/buffer/slide-${numero}.jpg`
